...
## 🧩 Features
- Notepad++–inspired light layout with modern clarity  
...
1. Download the latest `.vsix` file (e.g., `incognito-1.0.8.vsix`)  
2. Open VS Code and run this command in **PowerShell** or your **terminal**:
